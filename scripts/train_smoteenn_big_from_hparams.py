...
def main():
    ap = argparse.ArgumentParser(description="Train SMOTEENN BIG models (no shorts buckets) from cached hparams.")
    ...
    for tag in tags:
        ...
        for feats in feats_list:
            ...
            # resample in MinMax-scaled space
            ...
            # 3 models (each includes its own MinMaxScaler)
            lr_hp = best["logreg"]
            logreg = Pipeline([
                ("scaler", MinMaxScaler()),
